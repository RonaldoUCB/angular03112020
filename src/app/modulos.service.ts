...
export class ModulosService{
    modulos = [
        ...
        {"modulo":"Modulo 2","imagen":"./assets/php.png","descripcion":"En este segundo modulo, se estudiara otros conceptos de tecnolias web. Estas son php. Php nos permitira entender el funcionamiento back-end de actividades en la web."},
